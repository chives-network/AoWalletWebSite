  ...
  return (
    <Box
        ...
        <TableContainer>
                    ...
                    <Fragment key={Index}>
                        {Item[1] != '' &&  (
                            <TableRow key={Index} sx={{my: 0, py: 0}}>
                                ...
                                <TableCell sx={{my: 0, py: 0}}>
                                    {Item && Item[3] && Item[3] == 'Sent' && (
                                        <Icon icon='mdi:upload-circle-outline' />
                                    )}
                                    {Item && Item[3] && Item[3] == 'Received' && (
            ...
            {tokenGetInfor && tokenGetInfor.AoTokenMyAllTransactionsList && tokenGetInfor.AoTokenMyAllTransactionsList.length == 0 && tokenGetInfor.isLoading == false && (
                <Box sx={{ pl: 5, py: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                    <Grid item key={"Pagination"} xs={12} sm={12} md={12} lg={12} sx={{ padding: '10px 0 10px 0' }}>
